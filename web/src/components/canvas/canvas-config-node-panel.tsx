    ...
    return (
        <div className="flex h-full w-full cursor-move flex-col px-3 pb-3 pt-7 text-sm" style={{ color: theme.node.text }} onWheel={(event) => event.stopPropagation()}>
            ...
            <div className="mb-2 flex flex-wrap gap-1.5">
                <InputChip label={t("configNode.prompt")} value={t("configNode.count", { count: inputSummary.textCount })} style={chipStyle} />
                <InputChip label={t("configNode.referenceImage")} value={t("configNode.imageCount", { count: inputSummary.imageCount })} style={chipStyle} />
                <InputChip label={t("configNode.referenceVideo")} value={t("configNode.count", { count: inputSummary.videoCount })} style={chipStyle} />
                <InputChip label={t("configNode.referenceAudio")} value={t("configNode.count", { count: inputSummary.audioCount })} style={chipStyle} />
                ...
                <span className="inline-flex items-center gap-1.5">
                    {isRunning ? (
                        <>
                            ...
                            <span>{t("configNode.stop")}</span>
                        </>
                    ) : (
                        <>
                            <Play className="size-4" />
                            <span>{t("configNode.start")}</span>
                        </>
                    )}
                </span>
            </Button>
