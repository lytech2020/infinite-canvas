...
export function ImageToolSettingsModal({
    ...
    const previewTools: PreviewTool[] = [
        ...selectedTools,
        { id: "more", title: t("nodeToolbar.configureTools"), label: t("nodeToolbar.more"), icon: <Ellipsis className="size-4" />, active: true },
    ];
    ...
    return (
            ...
            footer={
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                        <span>{t("nodeToolbar.showLabels")}</span>
                        <Switch checked={showLabels} onChange={onShowLabelsChange} />
                    </div>
                    <Space>
                        <Button onClick={onCancel}>{t("nodeToolbar.cancel")}</Button>
        ...
        >
            <Typography.Paragraph type="secondary" className="!mb-4">
                {t("nodeToolbar.customizeDescription")}
            ...
            >
                <div className="relative flex min-h-[300px] w-full justify-center pt-20 pb-9">
                    ...
                    >
                        ...
                        <Typography.Text type="secondary">{t("nodeToolbar.imageNode")}</Typography.Text>
                    </div>
                    <input
            ...
            <Form layout="vertical" className="!mb-0">
                <Form.Item
                    ...
                    label={
                        <Space size={8}>
                            <span>{t("nodeToolbar.quickTools")}</span>
                            <Tag className="m-0">
