...
export const imageQualityOptions = qualityOptions.map((item) => ({ value: item.value, get label() { return imageQualityLabel(item.value); } }));
...
export function ImageSettingsPanel({ config, onConfigChange, theme, showTitle = true, className = "w-[320px] space-y-4 rounded-2xl px-1 py-0.5", maxCount = 15, quickCount = 10 }: ImageSettingsPanelProps) {
    ...
    return (
        <ImageSettingsTheme theme={theme}>
            ...
            >
                {showTitle ? <div className="text-lg font-semibold">{t("image.title")}</div> : null}
                ...
                <div className="space-y-2.5">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span title={t("image.align16Hint")} onMouseDown={(event) => event.stopPropagation()}>
                ...
                <div className="space-y-2.5">
                    <SettingTitle color={theme.node.muted}>{t("image.aspectRatio")}</SettingTitle>
                    <div className="grid grid-cols-4 gap-2.5">
                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="space-y-0.5">
                        <SettingTitle color={theme.node.muted}>{t("image.transparent")}</SettingTitle>
                        <div className="text-xs" style={{ color: theme.node.muted, opacity: 0.75 }}>
                            {t("image.transparentHint")}
                        </div>
                    </div>
...
export function imageQualityLabel(value: string) {
    return ({ auto: i18n.t("auto", { ns: "settings" }), high: i18n.t("high", { ns: "settings" }), medium: i18n.t("medium", { ns: "settings" }), low: i18n.t("low", { ns: "settings" }) } as Record<string, string>)[value] || value;
}
