                    ...
                    <div className="mx-auto flex h-full max-w-7xl items-stretch justify-between gap-5 px-6">
                        <div className="flex min-w-0 items-center">
                            ...
                            <button
                                ...
                                title={t("menuTitle", { ns: "navigation" })}
                            >
                                ...
                                {navigationTools.map((tool) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span className="truncate">{t(tool.labelKey, { ns: "navigation" })}</span>
                                        </Link>
                                    );
                                })}
                            </nav>
                        ...
                        <div className="my-auto flex h-9 min-w-0 items-center justify-end gap-2 justify-self-end whitespace-nowrap">
                            <Tooltip title={panelOpen ? t("agent.close") : t("agent.open")}>
                                <Button type="text" shape="circle" className="!h-8 !w-8 !min-w-8" icon={<Bot className="size-4" />} onClick={togglePanel} aria-label={panelOpen ? t("agent.close") : t("agent.open")} />
                            </Tooltip>
                            <UserStatusActions />
                        </div>
                    </div>
