    ...
    return (
        <ImageSettingsTheme theme={theme}>
            <div className={className} style={{ color: theme.node.text }} onMouseDown={(event) => event.stopPropagation()}>
                {showTitle ? <div className="text-lg font-semibold">{t("audio.title")}</div> : null}
                <SettingGroup title={t("audio.voice")} color={theme.node.muted}>
                ...
                <SettingGroup title={t("audio.format")} color={theme.node.muted}>
                    <div className="grid grid-cols-3 gap-2.5">
                ...
                <SettingGroup title={t("audio.speed")} color={theme.node.muted}>
                ...
                <SettingGroup title={t("audio.instructions")} color={theme.node.muted}>
                    <textarea
                        value={config.audioInstructions || ""}
                        placeholder={t("audio.instructionsPlaceholder")}
